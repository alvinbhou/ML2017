...
print(X_data[2], tag_list[2])
# print(tag_list[2],tag_list[4])
...
model.add(Embedding(num_words,
                    ...
                    trainable=False))
model.add(GRU(350, activation='tanh',dropout=0.2))
...
checkpoint = ModelCheckpoint(filepath= 'result/' + str(start_time) + 'best.hdf5',
                                verbose=1,
                                save_best_only=True,
...
thresh = 0.4
with open( 'result/' + str(start_time) + output_path,'w') as output:
