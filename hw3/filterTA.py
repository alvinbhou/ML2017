...
def grad_ascent(num_step,input_image_data,iter_func, idx):
    ...
    for i in range(num_step):
        ...
        input_image_data += grads_value * i  
        filter_imgs[t][idx]  =  input_image_data
    return input_image_data


name = '1493755856_62.7906976744model.h5'
emotion_classifier = load_model('tensorflow_model/' + name)   
...
for cnt, c in enumerate(collect_layers):
    ...
    for filter_idx in range(nb_filter):
        ...
        filter_imgs = grad_ascent(num_step, input_img_data, iterate,filter_idx )
        ###
